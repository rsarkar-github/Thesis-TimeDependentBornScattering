...
if __name__ == "__main__":
    ...
    if os.path.exists("Data/" + filestr + "_ir0.npz"):
        x0 = np.load("Data/" + filestr + "_ir0.npz")["arr_0"]
    else:
    ...
    # Save results
    np.savez("Thesis-TimeDependentBornScattering/Data/" + filestr + "_ir0.npz", dm_invert, resid, cgobj)
